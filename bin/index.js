...
const { displayVersion, displayHelp, displayeasierInfo, 
  generateHTMLFile, createFolder,createFileInSubfolder,displayDirectoryTree,
  generateReactNativeApp,historyCommands,displayCommandHistory,removeEasier,checkEasierFile,
  generateSpringBatchProject,
  cyan, red, green, reset } = require('./utils');
...
function main() {
  ...
  if (commandArgs.length !== 2) {
    ...
    // const templatePath = 'C:\\Users\\ahmed\\Desktop\\projects\\easier_MOBILE_MODULES\\template';
  ...
  checkEasierFile();
    ...
    console.error(`Usage: ${red}error in command line syntax${reset}`);
    process.exit(1);
  }
}
